...
const WOW_POSITION_OPTIONS = [
  ...
  { id: "dealer", label: "딜러", shortLabel: "딜" },
...
const normalizePreferredPositions = (value) => {
  ...
  return raw.filter(
    (positionId, index) =>
      WOW_POSITION_IDS.includes(positionId) && raw.indexOf(positionId) === index
  );
};
...
export default function App() {
  ...
  const wowPositionStats = useMemo(() => {
    const stats = { 전체: wowRoster.length, tank: 0, dealer: 0, heal: 0 };
    wowRoster.forEach((member) => {
  ...
  const raidAssignedPositionStats = useMemo(() => {
    const stats = { tank: 0, dealer: 0, heal: 0, undecided: 0 };
                ...
                {wowPositionStats.orderedIds.map((positionId) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-black border transition whitespace-nowrap flex-shrink-0 ${
                        isSelected
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {normalizePreferredPositions(
                              ...
                              normalizePreferredPositions(
                                ...
                                <span
                                  key={positionId}
                                  className="inline-flex items-center px-2 py-1 rounded-full bg-white text-black text-[15px] font-black border border-white/80 whitespace-nowrap leading-none"
                                >
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="flex items-center gap-1 mt-1.5 flex-wrap">
                                  {normalizePreferredPositions(
                                    ...
                                    <span
                                      key={positionId}
                                      className="inline-flex items-center px-1.5 py-0.5 rounded-full bg-white text-black text-[10px] font-black border border-white/80 whitespace-nowrap"
                                    >
                                      {getWowPositionShortLabel(positionId)}
                                    </span>
                                  ))}
                ...
                <div className="flex flex-col gap-2 items-start lg:items-end">
                  ...
                  <div className="flex flex-wrap gap-2 justify-start lg:justify-end">
                    {WOW_POSITION_OPTIONS.filter(
                      ...
                      <span
                        key={option.id}
                        className="inline-flex items-center px-2.5 py-1 rounded-full bg-white text-black text-[11px] font-black border border-white/80"
                      >
                        {option.shortLabel}{" "}
                        <span className="ml-1">
