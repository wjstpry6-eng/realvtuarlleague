        ...
        <div className={`grid ${raidLayoutGridClass} gap-5 items-stretch`}>
          {isRaidWaitingRoomCollapsed ? (
            <div className={raidWorkspacePanelHeightClass}>
              <div
                className={`rounded-2xl border border-gray-700 bg-gray-800/90 shadow-xl overflow-visible flex flex-col ${raidWorkspacePanelHeightClass}`}
              >
            ...
            <div className={raidWorkspacePanelHeightClass}>
              <div
                className={`rounded-2xl border border-gray-700 bg-gray-800/90 shadow-xl overflow-hidden flex flex-col ${raidWorkspacePanelHeightClass}`}
              >
                ...
                <div className="p-4 space-y-2.5 border-b border-gray-700/70 shrink-0 bg-gray-800/95">
                  ...
                  <div className="min-h-0 flex-1 overflow-y-auto custom-scrollbar px-4 pb-4 pt-3">
                    {raidSelectedMember &&
                      !raidSelectedMember.isGuildMaster && (
          ...
          <div
            className={`space-y-5 min-w-0 ${raidWorkspacePanelHeightClass}`}
              ...
              <div className="px-4 py-3 border-b border-gray-700 bg-gray-900/60 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                      ...
                      >
                        ...
                        <div className="space-y-2 max-h-72 overflow-y-auto custom-scrollbar pr-1">
                          ...
                          {sortedFixedRaidMembers.map((member) => {
                            const isSelected =
                              selectedFixedRaidMemberOptionId === member.id;
                            return (
                              <button
                                key={member.id}
                                type="button"
                                onClick={() =>
                                  handleSelectFixedRaidMemberOption(member.id)
                                }
                                className={`w-full flex items-center gap-3 rounded-2xl border px-3 py-2.5 text-left transition ${
                                  isSelected
                                    ? "border-amber-400/50 bg-amber-500/10 text-amber-100"
                ...
                <div className="flex flex-col gap-2 items-start lg:items-end">
                  ...
                  <div className="flex flex-wrap gap-2 justify-start lg:justify-end">
                    ...
                    {raidAssignedPositionStats.undecided > 0 && (
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              className={`${raidSlotInfoClass} text-gray-400`}
                            >
