...
export default function App() {
  ...
  // ★ 새로 추가됨: 직업 버튼을 눌렀을 때 작동하는 함수 ★
  const handleJobFilterClick = (job) => {
    setSelectedJobFilter(job);
    setWowSortConfig({ key: "level", direction: "desc" }); // 클릭 시 무조건 레벨 내림차순 정렬
  };
