          ...
          <div className="p-5 border-b border-gray-700 bg-gray-800/50 flex flex-col gap-4 relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-auto">
                ...
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-fuchsia-500/10 via-violet-500/5 to-blue-500/10 opacity-80 group-hover:opacity-100 transition"></span>
                  <span className="relative flex items-center">
                    <Sparkles className="w-4 h-4 mr-1.5 text-fuchsia-300 group-hover:text-white" />
        ...
        <div className="relative overflow-hidden rounded-3xl border border-fuchsia-500/20 bg-gradient-to-r from-[#1b1331] via-[#141a33] to-[#10203a] p-8 shadow-[0_20px_60px_rgba(76,29,149,0.18)]">
          ...
          <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/5 border border-white/10 text-fuchsia-200 text-xs font-black tracking-[0.2em] mb-4">
                HIDDEN TAB · WOW RAID BUILDER
              </div>
              <h2 className="text-3xl md:text-4xl font-black text-white mb-3 flex items-center">
                <Wand2 className="w-8 h-8 mr-3 text-fuchsia-300" /> 레이드
                만들기
              </h2>
              <p className="text-gray-200 leading-relaxed text-base md:text-lg break-keep">
                왼쪽 명단에서 참가자를 끌어다가 오른쪽 슬롯에 바로 놓을 수 있는
                레이드 편성 전용 화면입니다.
                <span className="text-fuchsia-300 font-black">
                  {" "}
                  10인 · 20인 · 25인 · 40인
                </span>{" "}
                레이드 중 원하는 규모를 고르고, 주소창의{" "}
                <span className="text-blue-300 font-black">#raid</span> 해시를
                공유하면 다른 사람도 곧바로 이 화면으로 들어올 수 있습니다.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 min-w-full xl:min-w-[460px]">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                <div className="text-xs text-gray-400 mb-1">고정 길드장</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(320px,0.95fr)_minmax(0,1.55fr)] gap-6 items-start">
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-gray-700 bg-gray-800/90 shadow-xl overflow-hidden">
              ...
              <div className="p-5 grid grid-cols-1 2xl:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-stretch min-h-[88px]">
                                  ...
                                  <div className="flex-1 p-4">
                                    <div className="flex items-start justify-between gap-3">
                                      <div>
                                        <div className="text-xs font-black tracking-[0.18em] text-gray-500 mb-1">
                                        ...
                                        {member ? (
                                          <div className="flex items-center gap-3 min-w-0">
                                            {member.isGuildMaster ? (
                                              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-yellow-300/25 via-amber-300/10 to-yellow-500/25 border border-yellow-400 shadow-[0_0_16px_rgba(250,204,21,0.28)] flex items-center justify-center text-2xl shrink-0">
                                                👑
                                              </div>
                                            ) : (
                                              <img
                                            ...
                                            <div className="min-w-0">
                                              <div className="flex items-center gap-2 flex-wrap">
                                                ...
                                                {isLocked && (
                                                  <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-yellow-500/15 text-yellow-300 border border-yellow-500/30 text-[10px] font-black">
                                                    👑 고정 길드장
                                                  </span>
                                                )}
                                              </div>
                                      ...
                                      {member && !isLocked && (
                                        <button
                                          ...
                                          className="w-8 h-8 rounded-full border border-gray-700 bg-gray-900 text-gray-400 hover:text-white hover:border-red-400/40 hover:bg-red-500/10 flex items-center justify-center transition shrink-0"
                                          aria-label="슬롯에서 제거"
                                        >
                                          <X className="w-4 h-4" />
                                        </button>
