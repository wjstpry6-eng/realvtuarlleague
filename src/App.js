        ...
        <div className={`grid ${raidLayoutGridClass} gap-5 items-start`}>
            ...
            <div>
              <div className="rounded-2xl border border-gray-700 bg-gray-800/90 shadow-xl overflow-hidden flex flex-col">
                ...
                <div className="p-4 space-y-2.5 border-b border-gray-700/70 shrink-0 bg-gray-800/95">
                  ...
                  <div
                    className={`overflow-y-auto custom-scrollbar px-4 pb-4 pt-3 ${raidWaitingRoomListHeightClass}`}
                  >
                    {raidSelectedMember &&
          ...
          >
            <div className="rounded-2xl border border-gray-700 bg-gray-800/90 shadow-xl overflow-hidden flex flex-col">
              ...
              <div
                className={`overflow-y-auto custom-scrollbar ${raidPartyListHeightClass}`}
              >
