  ...
  useEffect(() => {
    ...
    setRaidAssignedPreferredPositions((prev) => {
      ...
      raidAssignedMembers.forEach((member) => {
        ...
        if (
          preferredPositions.length > 1 &&
          currentAssignedPosition &&
          preferredPositions.includes(currentAssignedPosition)
        ) {
                                  ...
                                  {member && (
                                    ...
                                    >
                                      {(() => {
                                        ...
                                        const hasSinglePreferredPosition =
                                          preferredPositionIds.length === 1;
                                        const assignedPositionLabel =
                                          assignedPositionId
                                            ? getWowPositionShortLabel(
                                                assignedPositionId
                                              )
                                            : hasSinglePreferredPosition
                                            ? getWowPositionShortLabel(
                                                preferredPositionIds[0]
                                              )
                                            : "미정";
                                        const isPositionMenuOpen =
                                          raidPositionMenuSlotKey === slotKey;
                                        return preferredPositionIds.length >
                                          0 ? (
                                          <div
                                            className="relative"
                                            data-raid-floating-layer="true"
                                          >
                                            ...
                                            {!hasSinglePreferredPosition &&
                                              isPositionMenuOpen && (
                                                <div
                                                  data-raid-role-panel="true"
                                                  className="absolute right-0 top-[calc(100%+10px)] z-30 w-36 rounded-2xl border border-gray-700 bg-gray-950/95 backdrop-blur p-2 shadow-2xl"
                                                >
